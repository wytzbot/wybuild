...
export const listRuns = (owner, repo) => api(`/api/github/runs?owner=${encodeURIComponent(owner)}&repo=${encodeURIComponent(repo)}`);
export const getRun = (owner, repo, id) => api(`/api/github/run?owner=${encodeURIComponent(owner)}&repo=${encodeURIComponent(repo)}&id=${id}`);
export const listArtifacts = (owner, repo, id) => api(`/api/github/artifacts?owner=${encodeURIComponent(owner)}&repo=${encodeURIComponent(repo)}&id=${id}`);
export const getLogsUrl = (owner, repo, id) => `/api/github/logs?owner=${encodeURIComponent(owner)}&repo=${encodeURIComponent(repo)}&id=${id}`;
